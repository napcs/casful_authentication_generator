...
=== 0.4.0 = February 14th, 2011
* Corrected a double-render situation relating to current_user and login_required.
  * login_required method now correctly calls access_denied directly
  * login_from_cas no longer calls access_denied directly. 
